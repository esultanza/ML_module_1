# Использование алгоритма Логистической регрессии. На самом деле, это не регрессия, а классификатор. Название историческое
...
# Некоторые модели могут предсказывать вероятности принадлежности к классу
