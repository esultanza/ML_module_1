...
# Использование стандартной библиотеки scikit-learn
...
# model.summary() # узнать число параметров нейрона (9)

# Выстроим более cложные сети (как упражнение)
# При большом количестве нейронов переобучение (overfitting) становится возможным
model = models.Sequential()
model.add(layers.Dense(32, activation="relu", input_dim=2))
model.add(layers.Dense(3, activation="softmax"))
model.summary() #51 параметр
